...
(copilot)=
### Thursday Jan 29
- conduct an informal audit of coding copilots with [copilot arena](https://marketplace.visualstudio.com/items?itemName=copilot-arena.copilot-arena) - you can do it more privately using a codespace or try it locally, but submit to [discussion repo](https://github.com/evalAI2eval/discussion-sp26/tree/main/copilotarena)
